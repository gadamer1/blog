  ...
  blocks: {
    ...
    atomic: function atomic(children, _ref8) {
      ...
      return children.map(function (child, i) {
        return __jsx(Atomic, Object(_babel_runtime_corejs2_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_6__["default"])({
          key: keys[i]
        }, data[i], {
          __source: {
            fileName: _jsxFileName,
...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Renderer, [{
    ...
    value: function render() {
      ...
      var rendered = redraft(raw, renderers); // redraft returns a null if there's nothing to render
...
//# sourceMappingURL=[title].js.9c02943d87caedf629c0.hot-update.js.map